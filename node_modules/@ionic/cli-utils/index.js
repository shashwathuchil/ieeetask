...
function generateIonicEnvironment(ctx, pargv, env) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const prompt = yield cli_framework_1.createPromptModule({
            ...
            onFallback: prompts_1.createOnFallback({ confirm: argv['confirm'], interactive: argv['interactive'], log }),
        });
        const tasks = cli_framework_1.createTaskChainWithOutput(argv['interactive']
            ? { output: prompt.output }
            : { output: { stream: log.createWriteStream(cli_framework_1.LOGGER_LEVELS.INFO, false) } });
