...
function installPlatform(env, platform, cwd, extraArgs = []) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        try {
            yield env.shell.run('cordova', ['platform', 'add', platform, '--save', ...extraArgs], { fatalOnError: false, showError: false, cwd });
        }
        catch (e) {
            const s = String(e);
            if (s.match(/Platform [A-Za-z0-9-]+ already added/)) {
                ...
                yield env.shell.run('cordova', ['platform', 'save'], { cwd });
            }
            else {
