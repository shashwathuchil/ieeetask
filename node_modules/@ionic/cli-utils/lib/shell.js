...
class Shell {
    ...
    run(command, args, _a) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (killOnExit) {
                    process_1.onBeforeExit(() => tslib_1.__awaiter(this, void 0, void 0, function* () { return promise.p.kill(); }));
                }
                yield promise;
            }
            catch (e) {
    ...
    output(command, args, _a) {
        var { fatalOnError = true, showError = true, showCommand = false } = _a, crossSpawnOptions = tslib_1.__rest(_a, ["fatalOnError", "showError", "showCommand"]);
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const cmd = new shell_1.ShellCommand(command, args, crossSpawnOptions);
            const fullCmd = cmd.bashify();
            const truncatedCmd = fullCmd.length > 80 ? fullCmd.substring(0, 80) + '...' : fullCmd;
