        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                try {
                    ...
                    this.e.log.warn(`Error with ${chalk_1.default.bold(format_1.prettyPath(ionicVersionFilePath))} file: ${e}, trying ${chalk_1.default.bold(format_1.prettyPath(bowerJsonPath))}.`);
