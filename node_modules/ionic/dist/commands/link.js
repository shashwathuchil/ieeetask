...
Ultimately, this command sets the ${chalk_1.default.bold('pro_id')} property in ${chalk_1.default.bold(cli_utils_1.PROJECT_FILE)}, which marks this app as linked.
...
${chalk_1.default.cyan('[2]')}: ${chalk_1.default.bold('https://ionicframework.com/support/request')}
    ...
    lookUpApp(proId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            this.env.tasks.next(`Looking up app ${chalk_1.default.green(proId)}`);
            const appClient = yield this.getAppClient();
    ...
    chooseApp(apps) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { formatName } = yield Promise.resolve().then(() => require('@ionic/cli-utils/lib/app'));
