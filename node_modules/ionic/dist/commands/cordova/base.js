    ...
    preRunChecks(runinfo) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (this.project.directory) {
                ...
                if (!wwwExists) {
                    this.env.tasks.next(`Creating ${chalk_1.default.bold(format_1.prettyPath(wwwPath))} directory for you`);
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (runPlatform) {
                ...
                if (!platforms.includes(runPlatform)) {
                    yield installPlatform(this.env, runPlatform, cordova.root);
                }
            }
        });
    }
