...
Like running ${chalk_1.default.green('cordova platform')} directly, but adds default Ionic icons and splash screen resources (during ${chalk_1.default.green('add')}) and provides friendly checks.
    ...
    run(inputs, options, runinfo) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (action === 'add') {
                const { installPlatform } = yield Promise.resolve().then(() => require('@ionic/cli-utils/lib/integrations/cordova/project'));
                const [, extraArgs] = cli_framework_1.separateArgv(inputs);
                yield installPlatform(this.env, platformName, cordova.root, extraArgs);
            }
            else {
